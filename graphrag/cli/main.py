...
@app.command("causal-analysis")
def _causal_analysis_cli(
    config: Path | None = typer.Option(
        None,
        "--config",
        "-c",
    ...
    verbose: bool = typer.Option(
        ...
        "--verbose",
        "-v",
        help="Run the causal analysis with verbose logging.",
    ),
    output: Path | None = typer.Option(
        None,
        "--output",
    ...
    from graphrag.cli.causal_analysis import causal_analysis_cli
